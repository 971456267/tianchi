...
# -*- coding: utf-8 -*-
"""
Created on Sat Nov 18 18:33:34 2017
...
params = {'xgb_1':0.4,'xgb_2':0.2,'gbm':0.4} 
...
ffm_test_1 = np.memmap(path + "result/test_gbm_1.npy", dtype='float32', mode='r', shape=(test.shape[0], 220))
